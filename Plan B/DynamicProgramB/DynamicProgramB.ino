                ...
                { // run motors only if enabled
                    if (timeUp2sec)
                    {
                        ...
                        case 6:                                              // Checks if a character is received at all
                            ...
                            if (Scan.Available())
                            { // Checks if a scan is available
                                receivedChar = Scan.Get_IR_Data();
                                // Serial.println(receivedChar);
                                if (receivedChar != ' ')
                                { // Checks if ANY character is received
                                    charCounter++;
                                    if (charCounter > 5)
                        ...
                        case 7:                                                 // Reverses closer to signal
                        ...
                        case 8:                                              // Checks if the signal is a U
                            leftDriveSpeed = cMaxPWM * turningMultiplier;    // Slow down left wheel drive speed
                            rightDriveSpeed = cMaxPWM * turningMultiplier;   // Slow down right wheel drive speed
                            Bot.Left("D1", leftDriveSpeed, rightDriveSpeed); // Turn left
                            ...
                            { // Checks if a scan is available
                                ...
                                Serial.println(receivedChar);
                                if (receivedChar == 'U')
                                { // Checks if the received character is a U
                                    irUCounter++;
                                    if (irUCounter > 5)
                                    { // Checks for 5 consecutive U's
                                        Bot.Stop("D1");
                                        driveIndex++;
                                    }
                                }
                        ...
                        case 9:                                                 // Drive backwards
                            ...
                            if (sonar.ping_cm() <= 5)
                            {
                                sonarCounter++;
                                if (sonarCounter >= 150)
                                { // Check for 6 consecutive readings <= 2.50cm
                                    Bot.Stop("D1");
                            ...
                            break;
                        case 10:                                   // Deposits gems into collection container
