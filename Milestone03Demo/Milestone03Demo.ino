...
int armServoTopValue = 2100;
int armServoBottomValue = 1000;
int armServoPos = 2000;
int clawServoPos;
char irData = ' ';
            ...
            if (timeUp2sec) {
              ...
              switch (driveIndex) {  // cycle through drive states
                case 0:              // Stop
                  ...
                  setTarget(1, RightEncoder.lRawEncoderCount, 5);  // set target to drive forward 45.53cm
                ...
                case 1:                                                // Drive forward
                  ...
                  if (RightEncoder.lRawEncoderCount >= target) {
                    setTarget(-1, RightEncoder.lRawEncoderCount, 9.000);  // set next target to turn 90 degrees CCW
                    driveIndex = 2;                                       // next state: turn left
                  }
                  break;
                ...
                case 2:                                             // Turn left
                  ...
                  if (RightEncoder.lRawEncoderCount <= target) {
                    setTarget(1, RightEncoder.lRawEncoderCount, 10);  // set target to drive forwards 36.735cm
                    driveIndex = 3;                                   // next state: drive forward
                  }
                  break;
                ...
                case 3:                                                // Drive forward
                  ...
                  if (RightEncoder.lRawEncoderCount >= target) {
                    setTarget(-1, RightEncoder.lRawEncoderCount, 9.000);  // set next target to turn 90 degrees CCW
                    driveIndex = 4;                                       // next state: localize ping pong ball
                  }
                  break;
                ...
                case 4:
                  ...
                  if (RightEncoder.lRawEncoderCount <= target) {
                    setTarget(1, RightEncoder.lRawEncoderCount, 15);  // set target to drive forwards 36.735cm
                ...
                case 5:
                  ...
                  if (RightEncoder.lRawEncoderCount >= target) {
                    setTarget(-1, RightEncoder.lRawEncoderCount, 9.000);  // set next target to turn 90 degrees CCW
                    driveIndex = 6;                                       // next state: localize ping pong ball
                  }
                  break;
                ...
                case 6:
                  ...
                  if (RightEncoder.lRawEncoderCount <= target) {
                    setTarget(1, RightEncoder.lRawEncoderCount, 20);  // set target to drive forwards 36.735cm
                ...
                case 7:
                  ...
                  if (RightEncoder.lRawEncoderCount >= target) {
                    setTarget(-1, RightEncoder.lRawEncoderCount, 9.000);  // set next target to turn 90 degrees CCW
                    driveIndex = 8;                                       // next state: localize ping pong ball
                  }
                  break;
                ...
                case 8:
                  ...
                  if (RightEncoder.lRawEncoderCount <= target) {
                    setTarget(1, RightEncoder.lRawEncoderCount, 25);  // set target to drive forwards 36.735cm
