...
void setup() {
  ...
  wheelLDriveSpeed = cMaxPWM - cLeftAdjust;                                              // Set left wheel motor speed to max
  wheelRDriveSpeed = cMaxPWM - cRightAdjust;                                             // Set right wheel motor speed to max
